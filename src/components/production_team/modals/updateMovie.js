                            ...
                            <div className="container">
                                ...
                                <form>
                                        ...
                                        <div className="row d-flex">
                                            <div className="plusMinus">
                                                ...
                                                <div className="btn-group btn-group-sm" role="group"
                                                    ...
                                                    <button type="button" className="btn" onClick={handleDecrement}><i
                                                        className="fa fa-minus"/></button>
                                                    <button type="text" className="btn" disabled>{hours} </button>
                                                    <button type="button" className="btn" onClick={handleIncrement}><i
                                            ...
                                            <div className="plusMinus">
                                                ...
                                                <div className="btn-group btn-group-sm" role="group"
                                                     aria-label="Second group">
                                                    <button type="button" className="btn" onClick={handleDecrement2}><i
                                                        className="fa fa-minus"/></button>
                                                    <button type="text" className="btn" disabled>{minutes}</button>
                                                    <button type="button" className="btn" onClick={handleIncrement2}><i
                                                        className="fa fa-plus"/></button>
                                                </div>
                                            </div>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select name="genre" className="form-select " id="genere">
