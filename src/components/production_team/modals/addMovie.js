                            ...
                            <div className="container">
                                ...
                                <form>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select name="rating" id="rating" value="Select Ratings">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select name="language" id="language" value="Select Language">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select name="genre" id="genre" value="Select Genre">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select name="status" id="status" value="Select Status">
