...
export default function SelectedMovieCard(props) {
    ...
    function calcTotal() {
        let total =
            adultTicket * adultTicketPrice + childTicket * childTicketPrice
        setTotalPrice(total)
    }
            ...
            <div id="accordion">
                <div className="card mb-3">
                    <div className="row g-0">
                        ...
                        <div className="col-md-8">
                            <div className="card-body">
                                ...
                                <h4 className="tprice">
                                    ...
                                    Child-Ticket Price:{' '}
                                    <b className="price">
                                        LKR {theaterDetails.child_ticket_price}
                                        .00
                                    </b>
                                </h4>
                                <h4 className="tprice">
                                    ...
                                    Adult-Ticket Price:{' '}
                                    <b className="price">
                                        LKR {theaterDetails.adult_ticket_price}
                                        .00{' '}
                                    </b>
                                </h4>
                            </div>
                            <button
                                type="button"
                                id="viewMore"
                                className="btnView btn-lg"
                                data-toggle="collapse"
                                data-target="#collapseOne"
                                aria-expanded="true"
                                hidden={viewMoreHidden}
                                aria-controls="collapseOne"
                                onClick={() => {
                                    setViewLessHidden(false)
                                    setViewMoreHidden(true)
                                }}
                            >
                                View more
                                <img
                        ...
                        >
                            <div className="titl">
                                <h2 className="show"> Show Times</h2>
                            </div>
                            ...
                            <button
                                type="button"
                                className="btnless btn-lg"
                                data-toggle="collapse"
                                data-target="#collapseOne"
                                aria-expanded="false"
                                hidden={viewLessHidden}
                                aria-controls="collapseOne"
                                onClick={() => {
                                    setViewLessHidden(true)
